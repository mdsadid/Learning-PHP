...
<main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <p class="text-xl">
            <a href="<?= '/note?id=' . $note['id'] ?>" class="text-cyan-600 underline hover:text-cyan-500">Back</a>
        </p>
